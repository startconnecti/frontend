            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <Avatar className="h-12 w-12 border-2 border-primary/10">
                  <AvatarImage src={session.student?.avatarUrl} alt={session.student?.fullName || 'Student'} />
                  <AvatarFallback>{session.student?.fullName?.[0] || '?'}</AvatarFallback>
                </Avatar>
                <div>
                  <p className="font-bold">{session.student?.fullName || 'Unknown Student'}</p>
