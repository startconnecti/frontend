    ...
    <div className="space-y-4 border-b border-border/40 pb-4">
      <div className="flex items-center gap-2">
        <button
          ...
          className={`px-4 py-1.5 rounded-full text-xs font-bold transition-all ${activeStatus === 'all'
        ...
        <button
          ...
          className={`px-4 py-1.5 rounded-full text-xs font-bold transition-all ${activeStatus === 'unread'
              ? 'bg-primary text-primary-foreground'
              : 'bg-muted/50 text-muted-foreground hover:bg-muted'
            }`}
        >
      ...
      <div className="flex flex-wrap items-center gap-2">
        {TYPES.map((type) => (
          <button
            ...
            className={`px-3 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${activeType === type.value
